...
public class FamiliaInstrumentoDAO {
    ...
    /*
    Insere valores na tabela familia_instrumento. 
    ...
    */
    public Map<String, Long> inserir(FamiliaInstrumento familiaInstrumento){
        
        String sql = "INSERT INTO familia_instrumento (nome, descricao)"
                + "VALUES (?, ?)";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)){
                ...
                ps.setString(1, familiaInstrumento.getNome());
                ps.setString(2, familiaInstrumento.getDescricao());
                ...
                try(ResultSet rs = ps.getGeneratedKeys()){
                 ...
                 c.commit(); 
                 sucesso = true; 
                 System.out.println("Família de instrumento inserida com sucesso!");
            } 
               ...
               System.out.println("Erro inesperado ao inserir família de instrumento: " + e.getMessage());
    ...
    /*
    Seleciona todos os valores da tabela familia_instrumento.
    */
    
    public List<FamiliaInstrumento> listarTodos(){
        
        List<FamiliaInstrumento> familiasInstrumento = new ArrayList<>();
        String sql = "SELECT * FROM familia_instrumento";
        Connection c = null;
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql);
                ...
                */
                while(rs.next()){
                    ...
                    FamiliaInstrumento fi = new FamiliaInstrumento(rs.getLong("id"), rs.getString("nome"), rs.getString("descricao"));
       
                    familiasInstrumento.add(fi);
                }
            }  
            ...
            System.out.println("Erro inesperado ao listar famílias de instrumentos: " + e.getMessage());
        ...
        return familiasInstrumento;
    }
    
    /*
    Seleciona todos os valores da tabela familia_instrumento na tupla especificada pelo ID
    */
    
    public FamiliaInstrumento buscarPorID(long id){
        
        String sql = "SELECT * FROM familia_instrumento WHERE id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)){
                 ...
                 try (ResultSet rs = ps.executeQuery()) {
                    ...
                    if (rs.next()) {
                       ...
                       familiaInstrumento = new FamiliaInstrumento(rs.getLong("id"), rs.getString("nome"), rs.getString("descricao"));     

                   } else {

                       System.out.println("Nenhuma família de instrumento encontrada com o ID informado.");
                   }
                }
            }
            ...
            System.out.println("Erro SQL ao buscar família de instrumento: " + e.getMessage());

        } catch (Exception e) {

            System.out.println("Erro inesperado ao buscar família de instrumento: " + e.getMessage());
    ...
    /*
    Atualiza valores da tupla especificada através do ID na tabela familia_instrumento  
    */
    
    public Map<String, Long> atualizar(FamiliaInstrumento familiaInstrumento){
        
        String sql = "UPDATE familia_instrumento SET nome = ?, descricao = ? WHERE id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)) {
                ...
                ps.setString(1, familiaInstrumento.getNome());
                ps.setString(2, familiaInstrumento.getDescricao());
                ps.setLong(3, familiaInstrumento.getId());

                int atualizou = ps.executeUpdate();
                
                c.commit();

                if(atualizou > 0) System.out.println("Família de instrumento atualizada com sucesso!");
                else  {
                    
                    System.out.println("Nenhuma família de instrumento encontrada para atualizar.");
            ...
            System.out.println("Erro SQL ao atualizar família de instrumento: " + e.getMessage());
            ...
            System.out.println("Erro inesperado ao atualizar família de instrumento: " + e.getMessage());
            retornos.put("Codigo", erros);  
    ...
    /*
    Deleta valores da tupla especificada através do ID na tabela familia_instrumento  
    */
    
    public Map<String, Long> deletar(long id) {
        
        String sql = "DELETE FROM familia_instrumento WHERE id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)) {
                ...
                if (deletou > 0) {
                    ...
                    System.out.println("Família de instrumento deletada com sucesso!");

                } else {

                    System.out.println("Nenhuma família de instrumento encontrada com esse ID.");
                    retornos.put("Codigo", malSucedido);
            ...
            if (e.getErrorCode() == 1451) System.out.println("Não é possível deletar: existem dados de outra entidade relacionados a esta família de instrumento."); 
            ...
            System.out.println("Erro inesperado ao deletar família de instrumento: " + e.getMessage());
            retornos.put("Codigo", erros);
