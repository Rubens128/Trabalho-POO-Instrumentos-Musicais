...
public class AfinacaoDAO {
    ...
    /*
    Insere valores na tabela afinacao. 
    ...
    */
    public Map<String, Long> inserir(Afinacao afinacao){
        
        String sql = "INSERT INTO afinacao (nome, descricao, referencia)"
                + "VALUES (?, ?, ?)";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql, Statement.RETURN_GENERATED_KEYS)){
                ...
                ps.setString(1, afinacao.getNome());
                ps.setString(2, afinacao.getDescricao());
                ps.setString(3, afinacao.getReferencia());
                ...
                try(ResultSet rs = ps.getGeneratedKeys()){
                 ...
                 System.out.println("Afinação inserida com sucesso!");
            } 
               ...
               System.out.println("Erro inesperado ao inserir afinação: " + e.getMessage());
    ...
    /*
    Seleciona todos os valores da tabela afinacao.
    */
    
    public List<Afinacao> listarTodos(){
        
        List<Afinacao> afinacoes = new ArrayList<>();
        String sql = "SELECT * FROM afinacao";
        Connection c = null;
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql);
                ...
                */
                while(rs.next()){
                    ...
                    Afinacao a = new Afinacao.Builder(
                    
                            rs.getLong("id"),
                            rs.getString("nome")
                            
                    ).descricao(rs.getString("descricao")).referencia(rs.getString("referencia")).build();
            ...
            System.out.println("Erro inesperado ao listar afinações: " + e.getMessage());
    ...
    /*
    Seleciona todos os valores da tabela afinacao na tupla especificada pelo ID
    */
    
    public Afinacao buscarPorID(long id){
        
        String sql = "SELECT * FROM afinacao WHERE id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)){
                 ...
                 try (ResultSet rs = ps.executeQuery()) {
                    ...
                    if (rs.next()) {
                       ...
                       System.out.println("Nenhuma afinação encontrada com o ID informado.");
                   }
                }
            }
            ...
            System.out.println("Erro SQL ao buscar afinação: " + e.getMessage());

        } catch (Exception e) {

            System.out.println("Erro inesperado ao buscar afinação: " + e.getMessage());
    ...
    /*
    Atualiza valores da tupla especificada através do ID na tabela afinacao  
    */
    
    public Map<String, Long> atualizar(Afinacao afinacao){
        
        String sql = "UPDATE afinacao SET nome = ?, descricao = ?, referencia = ? WHERE id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)) {
                ...
                ps.setString(2, afinacao.getDescricao());
                ps.setString(3, afinacao.getReferencia());                
                ps.setLong(4, afinacao.getId());

                int atualizou = ps.executeUpdate();
                
                c.commit();

                if(atualizou > 0) System.out.println("Afinação atualizada com sucesso!");
                else  {
                    
                    System.out.println("Nenhuma afinação encontrada para atualizar.");
            ...
            System.out.println("Erro SQL ao atualizar afinação: " + e.getMessage());
            ...
            System.out.println("Erro inesperado ao atualizar afinação: " + e.getMessage());
            retornos.put("Codigo", erros);  
    ...
    /*
    Deleta valores da tupla especificada através do ID na tabela afinacao  
    */
    
    public Map<String, Long> deletar(long id) {
        
        String sql = "DELETE FROM afinacao WHERE id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)) {
                ...
                if (deletou > 0) {
                    ...
                    System.out.println("Afinação deletada com sucesso!");

                } else {

                    System.out.println("Nenhuma afinação encontrada com esse ID.");
                    retornos.put("Codigo", malSucedido);
            ...
            if (e.getErrorCode() == 1451) System.out.println("Não é possível deletar: existem dados de outra entidade relacionados a esta afinação."); 
            ...
            System.out.println("Erro inesperado ao deletar afinação: " + e.getMessage());
            retornos.put("Codigo", erros);
