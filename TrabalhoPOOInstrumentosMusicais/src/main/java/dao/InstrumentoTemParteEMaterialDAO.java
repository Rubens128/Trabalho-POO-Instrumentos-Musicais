...
public class InstrumentoTemParteEMaterialDAO {
    ...
    */
    public Map<String, Long> inserir(ParteEMaterial instrumentoTemParteEMaterial){
        ...
        String sql = "INSERT INTO instrumento_parte_material (instrumento_id, material_id, parteNome) VALUES (?, ?, ?)";
    ...
    */
    public List<ParteEMaterial> listarTodos(){
        ...
        String sql = "SELECT * FROM instrumento_parte_material";
        Connection c = null;
    ...
    */
    public ParteEMaterial buscarPorID(long id){
        
        String sql = "SELECT * FROM instrumento_parte_material WHERE id = ?";
    ...
    */
    public Map<String, Long> atualizar(ParteEMaterial instrumentoTemParteEMaterial, String escolha){
        
        String sql;
        
        if(escolha.equals("material_id")) sql = "UPDATE instrumento_parte_material SET instrumento_id = ?, material_id = ?, parte_nome = ? WHERE material_id = ?";
        else sql = "UPDATE instrumento_parte_material SET instrumento_id = ?, material_id = ?, parte_nome = ? WHERE instrumento_id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)) {
                ...
                ps.setLong(1, instrumentoTemParteEMaterial.getInstrumentoId());
                ps.setLong(3, instrumentoTemParteEMaterial.getMaterialId());
                ps.setString(2, instrumentoTemParteEMaterial.getParteNome());
