...
public class AlcanceInstrumentoDAO {
    ...
    */
    public Map<String, Long> inserir(AlcanceInstrumento alcanceInstrumento){
        
        String sql = "INSERT INTO alcance_instrumento (instrumento_id, tipo, nota_min, nota_max)"
                + "VALUES (?, ?, ?, ?)";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)){
                ...
                ps.setString(3, alcanceInstrumento.getNotaMin());
               ...
               System.out.println("Erro inesperado ao inserir alcance de instrumento: " + e.getMessage());
    ...
    /*
    Seleciona todos os valores da tabela alcance_instrumento.
    */
    
    public List<AlcanceInstrumento> listarTodos(){
        
        List<AlcanceInstrumento> alcancesInstrumento = new ArrayList<>();
        String sql = "SELECT * FROM alcance_instrumento";
        Connection c = null;
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql);
                ...
                */
                while(rs.next()){
                    ...
                    AlcanceInstrumento ai = new AlcanceInstrumento(

                            rs.getLong("instrumento_id"),
                            rs.getString("tipo"),
                            rs.getString("nota_min"),
                            rs.getString("nota_max")         
                    );
       
                    alcancesInstrumento.add(ai);
                }
            }  
            ...
            System.out.println("Erro inesperado ao listar alcances de instrumentos: " + e.getMessage());
        ...
        return alcancesInstrumento;
    }
    
    /*
    Seleciona todos os valores da tabela alcance_instrumento na tupla especificada pelo ID
    */
    
    public AlcanceInstrumento buscarPorID(long instrumento_id){
        
        String sql = "SELECT * FROM alcance_instrumento WHERE instrumento_id = ?";
        AlcanceInstrumento alcanceInstrumento = null;
        Connection c = null;
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)){
                 ...
                 try (ResultSet rs = ps.executeQuery()) {
                    ...
                    if (rs.next()) {
                       ...
                       alcanceInstrumento = new AlcanceInstrumento(
                       ...
                       System.out.println("Nenhum alcance de instrumento encontrado com o ID informado.");
                   }
                }
            }
            ...
            System.out.println("Erro SQL ao buscar alcance de instrumento: " + e.getMessage());

        } catch (Exception e) {

            System.out.println("Erro inesperado ao buscar alcance de instrumento: " + e.getMessage());
    ...
    /*
    Atualiza valores da tupla especificada através do ID na tabela alcance_instrumento  
    */
    
    public Map<String, Long> atualizar(AlcanceInstrumento alcanceInstrumento){
        
        String sql = "UPDATE alcance_instrumento SET tipo = ?, nota_min = ?, "
                + "nota_max = ? WHERE instrumento_id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)) {
                ...
                ps.setString(1, alcanceInstrumento.getTipo());
                ps.setString(2, alcanceInstrumento.getNotaMin());
                ps.setString(3, alcanceInstrumento.getNotaMax());
                ps.setLong(4, alcanceInstrumento.getInstrumentoId());

                int atualizou = ps.executeUpdate();
                
                c.commit();

                if(atualizou > 0) System.out.println("Alcance de instrumento atualizado com sucesso!");
                else  {
                    
                    System.out.println("Nenhum alcance de instrumento encontrado para atualizar.");
            ...
            System.out.println("Erro SQL ao atualizar alcance de instrumento: " + e.getMessage());
            ...
            System.out.println("Erro inesperado ao atualizar alcance de instrumento: " + e.getMessage());
            retornos.put("Codigo", erros);  
    ...
    /*
    Deleta valores da tupla especificada através do ID na tabela alcance_instrumento  
    */
    
    public Map<String, Long> deletar(long instrumento_id) {
        
        String sql = "DELETE FROM alcance_instrumento WHERE instrumento_id = ?";
        ...
        try {
            ...
            try (PreparedStatement ps = c.prepareStatement(sql)) {
                ...
                if (deletou > 0) {
                    ...
                    System.out.println("Alcance de instrumento deletado com sucesso!");

                } else {

                    System.out.println("Nenhum alcance de instrumento encontrado com esse ID.");
                    retornos.put("Codigo", malSucedido);
            ...
            if (e.getErrorCode() == 1451) System.out.println("Não é possível deletar: existem dados de outra entidade relacionados a este alcance de instrumento."); 
            ...
            System.out.println("Erro inesperado ao deletar alcance de instrumento: " + e.getMessage());
            retornos.put("Codigo", erros);
